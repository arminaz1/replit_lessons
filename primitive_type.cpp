...
void primitiveType() {
    ...
    cout << "char8_t\t\t\t" << sizeof(val_char8) << "\t\t" << (unsigned int)val_char8 << "\n";

    char16_t val_char16 = u'A';
    cout << "char16_t\t\t" << sizeof(val_char16) << "\t\t" << (unsigned int)val_char16 << "\n";

    char32_t val_char32 = U'A';
    cout << "char32_t\t\t" << sizeof(val_char32) << "\t\t" << (unsigned int)val_char32 << "\n";

    wchar_t val_wchar = L'Z';
    cout << "wchar_t\t\t\t" << sizeof(val_wchar) << "\t\t" << (unsigned int)val_wchar << "\n";
